"""
Django settings for django_shareit project.
...
SECRET_KEY = 'django-insecure-b-ip=7vgx#(75-2jziia$jnuewcpb9-s00b-op9tur2gdd5^4='
...
WSGI_APPLICATION = 'django_shareit.wsgi.application'
